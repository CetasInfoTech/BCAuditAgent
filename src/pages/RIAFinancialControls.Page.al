/// <summary>Financial Controls Center — risk alerts filtered to the Finance domain.</summary>
page 50106 "RIA Financial Controls"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    Editable = false;
    SourceTableView = sorting("Detected DateTime") order(descending) where(Domain = const(Finance));
