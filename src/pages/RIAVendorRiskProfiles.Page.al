/// <summary>Vendor Risk Profile — aggregated risk scores and exposure for Vendor entities.</summary>
page 50111 "RIA Vendor Risk Profiles"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    Editable = false;
    SourceTableView = sorting("Risk Score") order(descending) where("Profile Type" = const(Vendor));
