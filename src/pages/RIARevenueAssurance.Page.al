/// <summary>Revenue Assurance Center — risk alerts filtered to the Sales domain.</summary>
page 50108 "RIA Revenue Assurance"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    Editable = false;
    SourceTableView = sorting("Detected DateTime") order(descending) where(Domain = const(Sales));
